...
x_train = x_train.reshape(60000, 28, 28, 1) # 일반성 유지를 위해 (28, 28, 1)
...
cnn.fit(x_train, y_train, batch_size=128, epochs=10, validation_data=(x_test, y_test), verbose=2)
...
plt.subtitle('Kernels of conv2d_4')
